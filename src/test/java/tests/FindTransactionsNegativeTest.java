...
public class FindTransactionsNegativeTest extends BaseTest {
    ...
    public void invalidTransactionId() {
        ...
        Assert.assertFalse(findPage.isResultDisplayed(), "Invalid Transaction ID should not return a result");
    }
    @Test
    public void emptyTransactionId() {
        ...
        findPage.clickFindByTransactionId();
        Assert.assertFalse(findPage.isResultDisplayed(), "Empty Transaction ID should not return a result");
    }
    @Test
    public void invalidAmount() {
        ...
        Assert.assertFalse(findPage.isResultDisplayed(), "Invalid amount should not return a result");
    }
    @Test
    public void negativeAmount() {
        ...
        findPage.clickFindByAmount();
        Assert.assertFalse(findPage.isResultDisplayed(), "Negative amount should not return a result");
    }
    @Test
    public void invalidDateFormat() {
        ...
        Assert.assertFalse(findPage.isResultDisplayed(), "Invalid date format should not return a result");
    }
}
