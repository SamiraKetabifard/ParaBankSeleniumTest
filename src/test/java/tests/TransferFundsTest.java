...
public class TransferFundsTest extends BaseTest {
    ...
    public void transferValidTest() {
        ...
        System.out.println("Account count = " + accountsPage.getAccountCount());
        ...
        System.out.println("Title after transfer = " + driver.getTitle());
        System.out.println("Account count after transfer = " + accountsPage.getAccountCount());
        ...
        Assert.assertEquals(balanceAfter, balanceBefore - transferAmount,
                0.01, "Balance was not deducted correctly");
    }
}