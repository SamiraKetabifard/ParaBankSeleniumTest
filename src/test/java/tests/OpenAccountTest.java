...
public class OpenAccountTest extends BaseTest {
    ...
    public void verifyOpenNewAccount(String type){
        ...
        OpenAccountPage openAccountPage = accountsPage.clickOpenNewAccount();
        openAccountPage.selectAccountType(type).clickOpenAccount();
        Assert.assertTrue(openAccountPage.isAccountCreated(),"Account was not created for " + type);
    }
}