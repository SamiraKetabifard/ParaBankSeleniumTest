...
public class UpdateContactInfoNegativeTest extends BaseTest {
    ...
    public void emptyFirstNameTest() {
        ...
        updatePage.updateProfile("", "Smith", "Street", "City",
                "VA", "12345", "555555");
        Assert.assertTrue(updatePage.isErrorDisplayed(), "First name required message should appear");
    }
    @Test
    public void phoneFieldValidationBugTest() {
        ...
        driver.get("https://parabank.parasoft.com/parabank/updateprofile.htm");
        updatePage.updateProfile("John", "Smith", "Street",
                "City", "VA", "12345", "");
        Assert.assertTrue(updatePage.isProfileUpdated(),
