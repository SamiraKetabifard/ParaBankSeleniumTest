...
public class AccountsOverviewPage extends BasePage {
    ...
    private By accountsTitle = By.xpath("//h1[contains(text(),'Accounts Overview')]");
    ...
    private By accountRows = By.cssSelector("#accountTable tbody tr:has(td a)");
    ...
    private List<WebElement> getAccountRows() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accountTable tbody tr td a")));
